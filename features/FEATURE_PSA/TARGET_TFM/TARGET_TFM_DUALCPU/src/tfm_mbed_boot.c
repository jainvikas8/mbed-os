...
{
    /*
     * In case the of Dual Core, we need to initialize the IPC, Mailbox
     * NS interface after the RTOS has started to enable communication
     * from Secure and Non-Secure cores.
     */
    int32_t ret;
